...
const Spotlight = () => {
  ...
  const spotlightItems = [
    { name: "Kitchen Remodel - Norwood", img: "/spotlight/spotlight-img-1.jpg" },
    { name: "ADU & Home Renovation", img: "/spotlight/spotlight-img-2.jpg" },
    { name: "Custom Deck Build", img: "/spotlight/spotlight-img-3.jpg" },
    { name: "Finished Basement", img: "/spotlight/spotlight-img-4.jpg" },
    { name: "Handicap Accessible Bath", img: "/spotlight/spotlight-img-5.jpg" },
    { name: "Bathroom Renovation", img: "/spotlight/spotlight-img-6.jpg" },
    { name: "Front Entrance - Canton", img: "/spotlight/spotlight-img-7.jpg" },
    { name: "Kitchen Remodel - Newton", img: "/spotlight/spotlight-img-8.jpg" },
    { name: "Finished Attic Space", img: "/spotlight/spotlight-img-9.jpg" },
    { name: "Bay Window Installation", img: "/spotlight/spotlight-img-10.jpg" },
  ];
