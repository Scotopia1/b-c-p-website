  ...
  return (
    <>
          ...
          <div className="hero-content">
            <div className="hero-header">
              <Copy animateOnScroll={false} delay={showPreloader ? 10 : 0.85}>
                <h1>Building Quality Homes with Trust & Expertise</h1>
              </Copy>
            </div>
            <div className="hero-tagline">
              <Copy animateOnScroll={false} delay={showPreloader ? 10.15 : 1}>
                <p>
                  At BCP, we transform your home with over 25 years of construction excellence, treating every project as if it were our own.
                </p>
              </Copy>
            </div>
            <AnimatedButton
        ...
        <div className="container">
          ...
          <div className="what-we-do-content">
            <div className="what-we-do-col">
              ...
              <Copy delay={0.15}>
                <p className="lg">
                  We approach each project with integrity and craftsmanship. Every renovation is shaped through consultation, planning, and expert execution. What remains is quality work built to last and made to feel like home.
                </p>
              </Copy>
            </div>
            <div className="what-we-do-col">
      ...
      <section className="featured-projects-container">
        <div className="container">
          ...
          <div className="featured-projects-header">
            <Copy delay={0.15}>
              <h2>A selection of recent projects and completed renovations</h2>
            </Copy>
          </div>
        </div>
        <FeaturedProjects />
        ...
        <div className="container">
          ...
          <div className="gallery-callout-col">
            <div className="gallery-callout-copy">
              <Copy delay={0.1}>
                <h3>
                  Take a closer look at the projects that define our work. From kitchen remodels to custom decks, each image highlights quality craftsmanship that might inspire your next renovation.
                </h3>
              </Copy>
              <AnimatedButton label="View All Projects" route="/projects" />
            </div>
          </div>
        </div>
      </section>
      <CTAWindow
        ...
        header="BCP"
        callout="Building Trust, One Project at a Time"
        description="Our approach is guided by experience, transparency, and dedication, ensuring every renovation becomes a lasting part of your home."
        href="/about"
